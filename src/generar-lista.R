...
INPUT_CHECKLIST <- "data/interim/aranas_costarica.csv"
OUTPUT_CHECKLIST <- "data/processed/lista-taxonomica-referencia-aranas.csv"
OUTPUT_NOTFOUND_CHECKLIST <- "data/processed/lista-taxonomica-referencia-aranas-nombres-no-encontrados.csv"
...
input_checklist <- 
  input_checklist |>
  mutate(name = get_cleaned_species_name(Especies))
